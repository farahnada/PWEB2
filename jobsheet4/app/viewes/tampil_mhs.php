...
<div class="px-3 py-3">
    ...
    <!-- alert -->
    <?php
    if (isset($_GET['pesan']) && $_GET['pesan'] == 'berhasil1') { ?>
        <div class="alert alert-success mx-auto text-center" style="width:18%" role="alert">
            Data berhasil<a href="#" class="alert-link"> DITAMBAHKAN</a>
        </div>
    <?php
        header("refresh:2,url=tampil_mhs.php");
    } elseif (isset($_GET['pesan']) && $_GET['pesan'] == 'berhasil2') { ?>
    ...
    <?php
        header("refresh:2,url=tampil_mhs.php");
    } elseif (isset($_GET['pesan']) && $_GET['pesan'] == 'berhasil3') { ?>
